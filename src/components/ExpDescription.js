function ExpDescription() {
    return (
        <div className="description-style">
            <h3 className="description-style_header header-style margin-style">Career objective</h3>
            <p className="description-style_header margin-style">Junior Frontend Developer</p>

            <h3 className="description-style_header header-style margin-style">Summary</h3>
            <p className="description-style_header margin-style">I am the begining Frontend Developer.
            ...
            <h3 className="description-style_header header-style margin-style">Skills Highlights</h3>
            <div className="description-style_skills margin-style">
            ...
            <h3 className="description-style_header header-style margin-style">Work Experience</h3>
            <div className="description-style_border">
                ...
                <p className="description-style_comment"><span className="description-style_experience">Dates of employment:</span> from 2017 to 2021</p>
            ...
            <div className="description-style_border">
                ...
                <p className="description-style_comment"><span className="description-style_experience">Dates of employment:</span> from 2021 to 2022</p>
            ...
            <h3 className="description-style_header header-style margin-style">Education</h3>
            <div className="description-style_border">
            ...
            <div className="description-style_border">
                ...
                <a className="btn description-style_btn mb-1" href="../files/resume.pdf" download>Download Resume</a>
            </div>
        </div>
    )
}
